...
# Generated at: 05/07/2024 14:42:39
    ...
    # check for the application and throw if it cannot be found
        ...
        if ( $__handlerInfo.StreamOutput ) {
            if ( $null -eq $__handler ) {
                & "C:\Windows\System32\ipconfig.exe" $__commandArgs
            }
            else {
                & "C:\Windows\System32\ipconfig.exe" $__commandArgs 2>&1| Push-CrescendoNativeError | & $__handler
            }
        }
        else {
            $result = & "C:\Windows\System32\ipconfig.exe" $__commandArgs 2>&1| Push-CrescendoNativeError
            & $__handler $result
        }
    }
...
.PARAMETER all
List all the ip addresses assigned to your machine.
