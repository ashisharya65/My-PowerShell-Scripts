...
param(
    [Parameter(Mandatory, HelpMessage = "The Azure subscription id.")] $tenantId,
    [Parameter(Mandatory, HelpMessage = "The Azure subscription id.")] $subscription,
    ...
    [Parameter(Mandatory, HelpMessage = "The concerned timezone which you need to set. For eg. Indian Standard Time.")] $timezone
)
