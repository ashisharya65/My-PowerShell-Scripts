...
$TaskName = "Reset Shutdown Event Triggered Schd task"
...
$TaskTrigger.StateChange = "3"     # This will enable the "Connection from Remote computer" radio button in trigger settings of schd task
