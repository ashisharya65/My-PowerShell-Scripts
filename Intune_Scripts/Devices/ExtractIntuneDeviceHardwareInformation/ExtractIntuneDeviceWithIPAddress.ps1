...
<#
    .SYNOPSIS
        PowerShell script to get all Intune devices details like devicenames, local IP addresses & Primary usernames.
    
    .DESCRIPTION
        This script will extract a CSV report storing the Intune devices' names, local IP addresses and their primary usernames.
